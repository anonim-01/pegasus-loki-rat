...
from flask import Blueprint, request, abort, url_for, render_template, redirect, jsonify
...
@app.route('/api/download_payload/<int:agent_id>')
def download_payload(agent_id):
    # Replace with actual file path logic based on agent_id
    file_path = f"/path/to/payloads/{agent_id}.exe"
